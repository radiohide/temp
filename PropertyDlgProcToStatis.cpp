// PropertyDlgProcToStatis.cpp : implementation file
//
...
CPropertyDlgProcToStatis::CPropertyDlgProcToStatis(CWnd* pParent /*=NULL*/)
	: CDialog(CPropertyDlgProcToStatis::IDD, pParent)
{
	//{{AFX_DATA_INIT(CPropertyDlgProcToStatis)
	m_nStatType = 0;
	//}}AFX_DATA_INIT
}


void CPropertyDlgProcToStatis::DoDataExchange(CDataExchange* pDX)
{
	CDialog::DoDataExchange(pDX);
	//{{AFX_DATA_MAP(CPropertyDlgProcToStatis)
	DDX_Control(pDX, IDC_LIST, m_List);
	DDX_Text(pDX, IDC_EDIT_PSTAT_TYPE, m_nStatType);
	//}}AFX_DATA_MAP
}


BEGIN_MESSAGE_MAP(CPropertyDlgProcToStatis, CDialog)
	//{{AFX_MSG_MAP(CPropertyDlgProcToStatis)
...
BOOL CPropertyDlgProcToStatis::OnInitDialog()
{
...
void CPropertyDlgProcToStatis::initListBoxBody()
{
	int nItem=0;
	CString str;
...
void CPropertyDlgProcToStatis::initListBoxHead()
{
	UpdateData();
...
void CPropertyDlgProcToStatis::OnButtonAdd() 
{
...
void CPropertyDlgProcToStatis::OnButtonEdit() 
{
	// TODO: Add your control notification handler code here
...
void CPropertyDlgProcToStatis::OnButtonDel() 
{
	// TODO: Add your control notification handler code here
	POSITION pos = m_List.GetFirstSelectedItemPosition();
...
void CPropertyDlgProcToStatis::OnButtonInput() 
{
	// TODO: Add your control notification handler code here
...
void CPropertyDlgProcToStatis::OnButtonOutput() 
{
	// TODO: Add your control notification handler code here
	CString filename;
