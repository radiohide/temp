// StatUtilizationRate15.cpp: implementation of the CStatUtilizationRate15 class.
//
//////////////////////////////////////////////////////////////////////
...
CStatUtilizationRate15::CStatUtilizationRate15()
{
	ConstructBlockInputOutput();
	SetBlockType(_T( "StatUtilizationRate15" ) );
}
...
//根据类型新建对象的函数
CCalcBlock* CStatUtilizationRate15::CreateFromString( const CString& strType )
{
	CStatUtilizationRate15* obj = new CStatUtilizationRate15();
...
void CStatUtilizationRate15::ConstructBlockInputOutput ()
{
	AddInputPort("IniTime",VALUE_DOUBLE);
	AddInputPort("StandyByTime",VALUE_DOUBLE);
	AddInputPort("ManualDoTime",VALUE_DOUBLE);
	AddInputPort("StartUpTime",VALUE_DOUBLE);
	AddInputPort("RunUpTime",VALUE_DOUBLE);
	AddInputPort("PowerProdDoTime",VALUE_DOUBLE);
	AddInputPort("StopTime",VALUE_DOUBLE);
	AddInputPort("CommuErrorTime",VALUE_DOUBLE);
}
//初始化计算的函数做特殊的初始化
void CStatUtilizationRate15::InitCalc()
{
	CCalcBlock::InitCalc();
}

void CStatUtilizationRate15::Calc()//进行计算的函数,需要重载
{
...
void CStatUtilizationRate15::writeDataToTable(CString strTurbine,CString strTableName,TagData stateTable[],double dUtiliRate)
{
...
BOOL CStatUtilizationRate15::gIsTableExist(_ConnectionPtr &pConnection, CString strTableName)
{
...
void CStatUtilizationRate15::SetPropValue(CString strPropName,CString strItem1,CString strItem2,CString strItem3,CString strItem4,CString strItem5)
{
...
//重载以显示不同的属性对象对话框
void CStatUtilizationRate15::ShowPropertyDialog( CWnd* parent, BOOL show )
{
...
//重载以将本模块写入到数据库中
void CStatUtilizationRate15::PutPropertyToRecord(_RecordsetPtr& pRecord)
{
...
//复制图形时，需要拷贝属性。
void CStatUtilizationRate15::CopyPropertyData(CCalcBlock* pBlock)
{	
	this->m_strDBName=((CStatUtilizationRate15*)pBlock)->m_strDBName;//数据库名称
	this->m_strTableName=((CStatUtilizationRate15*)pBlock)->m_strTableName;
	this->m_strTurbine=((CStatUtilizationRate15*)pBlock)->m_strTurbine;
}
//将属性放置传输数据中
void CStatUtilizationRate15::SetBlockPropertyToTransferData(
			CArray<CBlockPropertyTransferData*,CBlockPropertyTransferData*&> &dataArr)
{

}

void CStatUtilizationRate15::DataRevise(TagData stateTable[],double &dSum)
{
...
//超出等比例缩放
void CStatUtilizationRate15::DataReviseR(TagData stateTable[],double dSum)
{
	double dSum2 = 0.0;
	for (int i=0;i<8;i++)
	{
