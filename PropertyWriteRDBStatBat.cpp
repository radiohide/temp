// PropertyWriteRDBStatBat.cpp : implementation file
//
...
CPropertyWriteRDBStatBat::CPropertyWriteRDBStatBat(CWnd* pParent /*=NULL*/)
	: CDialog(CPropertyWriteRDBStatBat::IDD, pParent)
{
	//{{AFX_DATA_INIT(CPropertyWriteRDBStatBat)

	//}}AFX_DATA_INIT
}


void CPropertyWriteRDBStatBat::DoDataExchange(CDataExchange* pDX)
{
	CDialog::DoDataExchange(pDX);
	//{{AFX_DATA_MAP(CPropertyWriteRDBStatBat)
...
BEGIN_MESSAGE_MAP(CPropertyWriteRDBStatBat, CDialog)
	//{{AFX_MSG_MAP(CPropertyWriteRDBStatBat)
...
/////////////////////////////////////////////////////////////////////////////
// CPropertyWriteRDBStatBat message handlers

BOOL CPropertyWriteRDBStatBat::OnInitDialog() 
{
...
void CPropertyWriteRDBStatBat::SetSourceRDBData(CArray<int,int> &m_ArrSourceRDBTagCon,
...
void CPropertyWriteRDBStatBat::initListBoxHead()
{
	UpdateData();
...
void CPropertyWriteRDBStatBat::initListBoxBody()
{
	int nItem=0;
	CString str;
...
void CPropertyWriteRDBStatBat::OnButtonAdd() 
{
...
void CPropertyWriteRDBStatBat::OnButtonEdit() 
{
	// TODO: Add your control notification handler code here
...
void CPropertyWriteRDBStatBat::OnButtonDel() 
{
	// TODO: Add your control notification handler code here
		POSITION pos = m_List.GetFirstSelectedItemPosition();
...
void CPropertyWriteRDBStatBat::OnButtonOutput() 
{
	// TODO: Add your control notification handler code here
	CString filename;
...
void CPropertyWriteRDBStatBat::OnButtonInput() 
{
	// TODO: Add your control notification handler code here
...
void CPropertyWriteRDBStatBat::OnDblclkList1(NMHDR* pNMHDR, LRESULT* pResult) 
{
	// TODO: Add your control notification handler code here
	OnButtonEdit();
	*pResult = 0;
...
void CPropertyWriteRDBStatBat::OnSelchangeComboDbsel() 
{
	// TODO: Add your control notification handler code here
