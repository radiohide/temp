// DBLastPointBlock.h: interface for the CDBLastPointBlock class.
//
//////////////////////////////////////////////////////////////////////

#if !defined(AFX_DBLASTPOINTBLOCK_H__241420D1_3FB1_456F_ADBF_20C082B9AEEF__INCLUDED_)
#define AFX_DBLASTPOINTBLOCK_H__241420D1_3FB1_456F_ADBF_20C082B9AEEF__INCLUDED_
...
class CDBLastPointBlock : public CCalcBlock  
{
public:
	CDBLastPointBlock();
	virtual ~CDBLastPointBlock();
public:
	//添加必要的虚函数：
	//-----------------------------------------------------------------------------------------------------------
...
#endif // !defined(AFX_DBLASTPOINTBLOCK_H__241420D1_3FB1_456F_ADBF_20C082B9AEEF__INCLUDED_)
