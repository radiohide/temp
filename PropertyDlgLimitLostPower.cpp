// PropertyDlgLimitLostPower.cpp : implementation file
//
...
CPropertyDlgLimitLostPower::CPropertyDlgLimitLostPower(CWnd* pParent /*=NULL*/)
	: CDialog(CPropertyDlgLimitLostPower::IDD, pParent)
{
	//{{AFX_DATA_INIT(CPropertyDlgLimitLostPower)
	dMaxPower = 0.0;
	//}}AFX_DATA_INIT
}


void CPropertyDlgLimitLostPower::DoDataExchange(CDataExchange* pDX)
{
	CDialog::DoDataExchange(pDX);
	//{{AFX_DATA_MAP(CPropertyDlgLimitLostPower)
...
BEGIN_MESSAGE_MAP(CPropertyDlgLimitLostPower, CDialog)
	//{{AFX_MSG_MAP(CPropertyDlgLimitLostPower)
...
/////////////////////////////////////////////////////////////////////////////
// CPropertyDlgLimitLostPower message handlers

BOOL CPropertyDlgLimitLostPower::OnInitDialog() 
{
...
void CPropertyDlgLimitLostPower::initListBoxHead2()
{
	UpdateData();
...
void CPropertyDlgLimitLostPower::initListBoxBody2()
{
	int nItem=0;
	CString str;
...
void CPropertyDlgLimitLostPower::OnButtonInput2() 
{
...
void CPropertyDlgLimitLostPower::OnButtonOutput2() 
{
	// TODO: Add your control notification handler code here
	CString filename;
...
void CPropertyDlgLimitLostPower::OnButtonAdd2() 
{
	// TODO: Add your control notification handler code here
	CDlgWindPower dlg;
	if(IDOK==dlg.DoModal())
...
void CPropertyDlgLimitLostPower::OnButtonEdit2() 
{
	// TODO: Add your control notification handler code here
...
void CPropertyDlgLimitLostPower::OnButtonDel2() 
{
	// TODO: Add your control notification handler code here
	POSITION pos = m_List2.GetFirstSelectedItemPosition();
...
void CPropertyDlgLimitLostPower::OnOK() 
{
...
void CPropertyDlgLimitLostPower::OnDblclkList4(NMHDR* pNMHDR, LRESULT* pResult) 
{
	// TODO: Add your control notification handler code here
	OnButtonEdit2();	
	*pResult = 0;
