// PropertyStandardWindPowerPerf.cpp : implementation file
//
...
/////////////////////////////////////////////////////////////////////////////
// CPropertyStandardWindPowerPerf dialog
CPropertyStandardWindPowerPerf::CPropertyStandardWindPowerPerf(CWnd* pParent /*=NULL*/)
	: CDialog(CPropertyStandardWindPowerPerf::IDD, pParent)
{
	//{{AFX_DATA_INIT(CPropertyStandardWindPowerPerf)
	m_strTableName = _T("");
	m_strTurbine = _T("");
	m_iPowerPorTag = 0;
...
void CPropertyStandardWindPowerPerf::DoDataExchange(CDataExchange* pDX)
{
	CDialog::DoDataExchange(pDX);
	//{{AFX_DATA_MAP(CPropertyStandardWindPowerPerf)
...
BEGIN_MESSAGE_MAP(CPropertyStandardWindPowerPerf, CDialog)
	//{{AFX_MSG_MAP(CPropertyStandardWindPowerPerf)
...
BOOL CPropertyStandardWindPowerPerf::OnInitDialog() 
{
...
void CPropertyStandardWindPowerPerf::SetSourceRDBData(CArray<int,int> &m_ArrSourceRDBTagCon,
...
void CPropertyStandardWindPowerPerf::OnSelchangeComboDbsel() 
{
...
/////////////////////////////////////////////////////////////////////////////
// CPropertyStandardWindPowerPerf message handlers
