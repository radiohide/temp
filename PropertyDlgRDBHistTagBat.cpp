// PropertyDlgRDBHistTagBat.cpp : implementation file
//
...
CPropertyDlgRDBHistTagBat::CPropertyDlgRDBHistTagBat(CWnd* pParent /*=NULL*/)
	: CDialog(CPropertyDlgRDBHistTagBat::IDD, pParent)
{
	//{{AFX_DATA_INIT(CPropertyDlgRDBHistTagBat)
	m_iNearSec = 0;
	//}}AFX_DATA_INIT
}


void CPropertyDlgRDBHistTagBat::DoDataExchange(CDataExchange* pDX)
{
	CDialog::DoDataExchange(pDX);
	//{{AFX_DATA_MAP(CPropertyDlgRDBHistTagBat)
...
BEGIN_MESSAGE_MAP(CPropertyDlgRDBHistTagBat, CDialog)
	//{{AFX_MSG_MAP(CPropertyDlgRDBHistTagBat)
...
/////////////////////////////////////////////////////////////////////////////
// CPropertyDlgRDBHistTagBat message handlers

void CPropertyDlgRDBHistTagBat::SetSourceRDBData(CArray<int,int> &m_ArrSourceRDBTagCon,
...
BOOL CPropertyDlgRDBHistTagBat::OnInitDialog() 
{
...
void CPropertyDlgRDBHistTagBat::initListBoxHead()
{
	UpdateData();
...
void CPropertyDlgRDBHistTagBat::initListBoxBody()
{
	int nItem=0;
	CString str;
...
void CPropertyDlgRDBHistTagBat::OnButtonRdbfield() 
{
...
void CPropertyDlgRDBHistTagBat::OnButtonInput() 
{
	// TODO: Add your control notification handler code here
...
void CPropertyDlgRDBHistTagBat::OnButtonOutput() 
{
	// TODO: Add your control notification handler code here
	CString filename;
...
void CPropertyDlgRDBHistTagBat::OnButtonAdd() 
{
	// TODO: Add your control notification handler code here
...
void CPropertyDlgRDBHistTagBat::OnButtonEdit() 
{
	// TODO: Add your control notification handler code here
...
void CPropertyDlgRDBHistTagBat::OnButtonDel() 
{
	// TODO: Add your control notification handler code here
			POSITION pos = m_List.GetFirstSelectedItemPosition();
...
void CPropertyDlgRDBHistTagBat::OnSelchangeComboDbsel() 
{
	// TODO: Add your control notification handler code here
	// TODO: Add your control notification handler code here
...
void CPropertyDlgRDBHistTagBat::OnDblclkList1(NMHDR* pNMHDR, LRESULT* pResult) 
{
	// TODO: Add your control notification handler code here
	OnButtonEdit();
	*pResult = 0;
