// PropertyWindPowerPerf.cpp : implementation file
//
...
CPropertyWindPowerPerf::CPropertyWindPowerPerf(CWnd* pParent /*=NULL*/)
	: CDialog(CPropertyWindPowerPerf::IDD, pParent)
{
	//{{AFX_DATA_INIT(CPropertyWindPowerPerf)
	m_strTableName = _T("");
	m_strTurbine = _T("");
	m_iPowerPorTag = 0;
...
void CPropertyWindPowerPerf::DoDataExchange(CDataExchange* pDX)
{
...
BEGIN_MESSAGE_MAP(CPropertyWindPowerPerf, CDialog)
...
BOOL CPropertyWindPowerPerf::OnInitDialog() 
{
...
void CPropertyWindPowerPerf::SetSourceRDBData(CArray<int,int> &m_ArrSourceRDBTagCon,
...
void CPropertyWindPowerPerf::OnSelchangeComboDbsel() 
{
