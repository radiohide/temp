// PropertyDlgRTDBHistSeriesBat.cpp : implementation file
//
...
CPropertyDlgRTDBHistSeriesBat::CPropertyDlgRTDBHistSeriesBat(CWnd* pParent /*=NULL*/)
	: CDialog(CPropertyDlgRTDBHistSeriesBat::IDD, pParent)
{
	//{{AFX_DATA_INIT(CPropertyDlgRTDBHistSeriesBat)
	iSnapshotSpan = 0;
	//}}AFX_DATA_INIT
}


void CPropertyDlgRTDBHistSeriesBat::DoDataExchange(CDataExchange* pDX)
{
	CDialog::DoDataExchange(pDX);
	//{{AFX_DATA_MAP(CPropertyDlgRTDBHistSeriesBat)
...
BEGIN_MESSAGE_MAP(CPropertyDlgRTDBHistSeriesBat, CDialog)
	//{{AFX_MSG_MAP(CPropertyDlgRTDBHistSeriesBat)
...
/////////////////////////////////////////////////////////////////////////////
// CPropertyDlgRTDBHistSeriesBat message handlers

BOOL CPropertyDlgRTDBHistSeriesBat::OnInitDialog() 
{
...
void CPropertyDlgRTDBHistSeriesBat::initListBoxHead()
{
	UpdateData();
...
void CPropertyDlgRTDBHistSeriesBat::initListBoxBody()
{
	int nItem=0;
	CString str;
...
void CPropertyDlgRTDBHistSeriesBat::OnButtonAdd() 
{
...
void CPropertyDlgRTDBHistSeriesBat::OnButtonEdit() 
{
	// TODO: Add your control notification handler code here
...
void CPropertyDlgRTDBHistSeriesBat::OnButtonDel() 
{
	// TODO: Add your control notification handler code here
		// TODO: Add your control notification handler code here
		POSITION pos = m_List.GetFirstSelectedItemPosition();
...
void CPropertyDlgRTDBHistSeriesBat::OnButtonInput() 
{
	// TODO: Add your control notification handler code here
...
void CPropertyDlgRTDBHistSeriesBat::OnButtonOutput() 
{
	// TODO: Add your control notification handler code here
	CString filename;
...
void CPropertyDlgRTDBHistSeriesBat::OnOK() 
{
...
void CPropertyDlgRTDBHistSeriesBat::OnRadio1() 
{
	// TODO: Add your control notification handler code here
	UpdateData();
	if(((CButton*)GetDlgItem(IDC_RADIO1))->GetCheck())
...
void CPropertyDlgRTDBHistSeriesBat::OnRadio2() 
{
	// TODO: Add your control notification handler code here
	UpdateData();
	if(((CButton*)GetDlgItem(IDC_RADIO1))->GetCheck())
...
void CPropertyDlgRTDBHistSeriesBat::OnDblclkList1(NMHDR* pNMHDR, LRESULT* pResult) 
{
	// TODO: Add your control notification handler code here
	OnButtonEdit();
	*pResult = 0;
