...
{
//	CString strLog;
//	strLog.Format("CDiagramEditor::Draw--start");
...
//	strLog.Format("CDiagramEditor::Draw--end");
//	g_Log.WriteFileData(strLog);
}
...
//	CString strLog;
//	strLog.Format("CDiagramEditor::OnLButtonDown--start");
//	g_Log.WriteFileData(strLog);
	...
	if( m_objs && m_interactMode == MODE_NONE )
	{
		...
		// Save to undo-stack...
		//if( m_interactMode != MODE_NONE )//release版本在使用时候是不是的出错
		//	m_objs->Snapshot();
...
//	strLog.Format("CDiagramEditor::OnLButtonDown--end");
//	g_Log.WriteFileData(strLog);
}
...
{
//	CString strLog;
//	strLog.Format("CDiagramEditor::OnMouseMove--start");
//	g_Log.WriteFileData(strLog);
...
//	strLog.Format("CDiagramEditor::OnMouseMove--end");
//	g_Log.WriteFileData(strLog);
}
...
{
//	CString strLog;
//	strLog.Format("CDiagramEditor::OnLButtonUp--start");
//	g_Log.WriteFileData(strLog);
	// Reset modes
	ReleaseCapture();
...
//	strLog.Format("CDiagramEditor::OnLButtonUp--end");
//	g_Log.WriteFileData(strLog);
}
