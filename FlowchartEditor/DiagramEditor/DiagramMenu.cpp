   ...
   ============================================================*/
{
	...
	if( m_menu.m_hMenu == NULL )
	{
		if( m_menu.CreatePopupMenu() )
		{
			...
			m_menu.AppendMenu( MF_STRING, ID_EDIT_CUT, _T( "剪切" ) );
			m_menu.AppendMenu( MF_STRING, ID_EDIT_COPY, _T( "复制" ) );
			m_menu.AppendMenu( MF_STRING, ID_EDIT_PASTE, _T( "粘帖" ) );

			m_menu.AppendMenu( MF_SEPARATOR );

			m_menu.AppendMenu( MF_STRING, ID_EDIT_GROUP, _T( "组合" ) );
			m_menu.AppendMenu( MF_STRING, ID_EDIT_UNGROUP, _T( "取消组合" ) );
		}
	}
