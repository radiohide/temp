   ...
   ============================================================*/
{
	...
	if( menu.CreatePopupMenu() )
	{
		...
		menu.AppendMenu( MF_STRING, CMD_CUT, _T( "剪切" ) );
		menu.AppendMenu( MF_STRING, CMD_COPY, _T( "复制" ) );
		menu.AppendMenu( MF_STRING, CMD_DUPLICATE, _T( "复制生成" ) );
		menu.AppendMenu( MF_SEPARATOR );
		menu.AppendMenu( MF_STRING, CMD_UP, _T( "上移一层" ) );
		menu.AppendMenu( MF_STRING, CMD_DOWN, _T( "下移一层" ) );
		menu.AppendMenu( MF_STRING, CMD_FRONT, _T( "置于顶层" ) );
		menu.AppendMenu( MF_STRING, CMD_BOTTOM, _T( "置于底层" ) );
		menu.AppendMenu( MF_SEPARATOR );
		menu.AppendMenu( MF_STRING, CMD_PROPERTIES, _T( "属性..." ) );
