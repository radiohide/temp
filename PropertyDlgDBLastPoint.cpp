// PropertyDlgDBLastPoint.cpp : implementation file
//
...
CPropertyDlgDBLastPoint::CPropertyDlgDBLastPoint(CWnd* pParent /*=NULL*/)
	: CDialog(CPropertyDlgDBLastPoint::IDD, pParent)
{
...
void CPropertyDlgDBLastPoint::DoDataExchange(CDataExchange* pDX)
{
...
BEGIN_MESSAGE_MAP(CPropertyDlgDBLastPoint, CDialog)
...
void CPropertyDlgDBLastPoint::OnRadio1() 
{
	// TODO: Add your control notification handler code here
	GetDlgItem(IDC_EDIT_OFFSET)->EnableWindow(false);
}

void CPropertyDlgDBLastPoint::OnRadio2() 
{
	// TODO: Add your control notification handler code here
	GetDlgItem(IDC_EDIT_OFFSET)->EnableWindow(true);
}

BOOL CPropertyDlgDBLastPoint::OnInitDialog() 
{
...
void CPropertyDlgDBLastPoint::SetSourceRDBData(CArray<int,int> &m_ArrSourceRDBTagCon,
...
void CPropertyDlgDBLastPoint::OnSelchangeComboDbsel() 
{
	// TODO: Add your control notification handler code here
...
void CPropertyDlgDBLastPoint::OnButtonRdbField() 
{
	// TODO: Add your control notification handler code here
