// PropertyDlgRDBStatTagBat.cpp : implementation file
//
...
CPropertyDlgRDBStatTagBat::CPropertyDlgRDBStatTagBat(CWnd* pParent /*=NULL*/)
	: CDialog(CPropertyDlgRDBStatTagBat::IDD, pParent)
{
	//{{AFX_DATA_INIT(CPropertyDlgRDBStatTagBat)
	m_iNearSec = 0;
	//}}AFX_DATA_INIT
}


void CPropertyDlgRDBStatTagBat::DoDataExchange(CDataExchange* pDX)
{
	CDialog::DoDataExchange(pDX);
	//{{AFX_DATA_MAP(CPropertyDlgRDBStatTagBat)
	DDX_Control(pDX, IDC_LIST1, m_List);
	DDX_Control(pDX, IDC_COMBO_DBSEL, m_comboBoxDBSel);
	DDX_Text(pDX, IDC_EDIT_NEAR_SEC, m_iNearSec);
	//}}AFX_DATA_MAP
}


BEGIN_MESSAGE_MAP(CPropertyDlgRDBStatTagBat, CDialog)
	//{{AFX_MSG_MAP(CPropertyDlgRDBStatTagBat)
...
/////////////////////////////////////////////////////////////////////////////
// CPropertyDlgRDBStatTagBat message handlers

void CPropertyDlgRDBStatTagBat::SetSourceRDBData(CArray<int,int> &m_ArrSourceRDBTagCon,
...
BOOL CPropertyDlgRDBStatTagBat::OnInitDialog() 
{
...
void CPropertyDlgRDBStatTagBat::initListBoxHead()
{
	UpdateData();
...
void CPropertyDlgRDBStatTagBat::initListBoxBody()
{
	int nItem=0;
	CString str;
...
void CPropertyDlgRDBStatTagBat::OnButtonRdbfield() 
{
...
void CPropertyDlgRDBStatTagBat::OnButtonInput() 
{
	// TODO: Add your control notification handler code here
...
void CPropertyDlgRDBStatTagBat::OnButtonOutput() 
{
	// TODO: Add your control notification handler code here
	CString filename;
...
void CPropertyDlgRDBStatTagBat::OnButtonAdd() 
{
	// TODO: Add your control notification handler code here
...
void CPropertyDlgRDBStatTagBat::OnButtonEdit() 
{
	// TODO: Add your control notification handler code here
...
void CPropertyDlgRDBStatTagBat::OnButtonDel() 
{
	// TODO: Add your control notification handler code here
			POSITION pos = m_List.GetFirstSelectedItemPosition();
...
void CPropertyDlgRDBStatTagBat::OnDblclkList1(NMHDR* pNMHDR, LRESULT* pResult) 
{
	// TODO: Add your control notification handler code here
	OnButtonEdit();
	*pResult = 0;
...
void CPropertyDlgRDBStatTagBat::OnSelchangeComboDbsel() 
{
	// TODO: Add your control notification handler code here
	// TODO: Add your control notification handler code here
