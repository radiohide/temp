// PropertyDlgStatProEnum.cpp : implementation file
//
...
CPropertyDlgStatProEnum::CPropertyDlgStatProEnum(CWnd* pParent /*=NULL*/)
	: CDialog(CPropertyDlgStatProEnum::IDD, pParent)
{
	//{{AFX_DATA_INIT(CPropertyDlgStatProEnum)
	m_dLeft = 0.0;
	m_dRight = 0.0;
	m_iStatType = 0;
	m_iFunType = -1;
...
void CPropertyDlgStatProEnum::DoDataExchange(CDataExchange* pDX)
{
	CDialog::DoDataExchange(pDX);
	//{{AFX_DATA_MAP(CPropertyDlgStatProEnum)
...
BEGIN_MESSAGE_MAP(CPropertyDlgStatProEnum, CDialog)
	//{{AFX_MSG_MAP(CPropertyDlgStatProEnum)
...
/////////////////////////////////////////////////////////////////////////////
// CPropertyDlgStatProEnum message handlers

BOOL CPropertyDlgStatProEnum::OnInitDialog() 
{
...
void CPropertyDlgStatProEnum::initListBoxHead()
{
	UpdateData();
...
void CPropertyDlgStatProEnum::initListBoxBody()
{
	int nItem=0;
	CString str;
...
void CPropertyDlgStatProEnum::OnButtonAdd() 
{
...
void CPropertyDlgStatProEnum::OnButtonEdit() 
{
	// TODO: Add your control notification handler code here
...
void CPropertyDlgStatProEnum::OnButtonDel() 
{
	// TODO: Add your control notification handler code here
	// TODO: Add your control notification handler code here
	POSITION pos = m_List.GetFirstSelectedItemPosition();
...
void CPropertyDlgStatProEnum::OnButtonInput() 
{
	// TODO: Add your control notification handler code here
	// TODO: Add your control notification handler code here
...
void CPropertyDlgStatProEnum::OnButtonOutput() 
{
	// TODO: Add your control notification handler code here
	// TODO: Add your control notification handler code here
	CString filename;
...
void CPropertyDlgStatProEnum::OnOK() 
{
