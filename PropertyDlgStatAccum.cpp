// PropertyDlgStatAccum.cpp : implementation file
//
...
CPropertyDlgStatAccum::CPropertyDlgStatAccum(CWnd* pParent /*=NULL*/)
	: CDialog(CPropertyDlgStatAccum::IDD, pParent)
{
	//{{AFX_DATA_INIT(CPropertyDlgStatAccum)
	m_comboBoxStatType = 0;
	m_dGain = 0.0;
	m_iConOn = FALSE;
	m_iConReqType = -1;
	m_strConDesp = _T("");
...
void CPropertyDlgStatAccum::DoDataExchange(CDataExchange* pDX)
{
	CDialog::DoDataExchange(pDX);
	//{{AFX_DATA_MAP(CPropertyDlgStatAccum)
	DDX_Control(pDX, IDC_COMBO_CON_FUN2, m_ComBoConFun2);
	DDX_Control(pDX, IDC_CHECK_CON, m_BtnCheckCon);
	DDX_Control(pDX, IDC_COMBO2, m_comboStatType);
	DDX_Control(pDX, IDC_COMBO_DBSEL, m_comboBoxDBSel);
	DDX_Control(pDX, IDC_LIST1, m_List);
	DDX_CBIndex(pDX, IDC_COMBO2, m_comboBoxStatType);
	DDX_Text(pDX, IDC_EDIT_GAINS, m_dGain);
	...
	DDX_CBIndex(pDX, IDC_COMBO_CON_FUN3, m_iCon1Fun);
	DDX_CBIndex(pDX, IDC_COMBO_CON_FUN2, m_iCon2Fun);
	//}}AFX_DATA_MAP
}


BEGIN_MESSAGE_MAP(CPropertyDlgStatAccum, CDialog)
	//{{AFX_MSG_MAP(CPropertyDlgStatAccum)
...
/////////////////////////////////////////////////////////////////////////////
// CPropertyDlgStatAccum message handlers

void CPropertyDlgStatAccum::OnButtonInput() 
{
...
void CPropertyDlgStatAccum::OnButtonOutput() 
{
	// TODO: Add your control notification handler code here
	CString filename;
...
void CPropertyDlgStatAccum::OnButtonAdd() 
{
	// TODO: Add your control notification handler code here
	UpdateData();
	CDlgVarDataWithReq dlg;
	if(this->m_comboBoxStatType==1)//首尾取差值
	{
		dlg.m_bEnableReqType=false;
	}
	if(IDOK==dlg.DoModal())
	{
...
void CPropertyDlgStatAccum::OnButtonEdit() 
{
	// TODO: Add your control notification handler code here
...
void CPropertyDlgStatAccum::OnButtonDel() 
{
	// TODO: Add your control notification handler code here
	POSITION pos = m_List.GetFirstSelectedItemPosition();
...
BOOL CPropertyDlgStatAccum::OnInitDialog() 
{
...
void CPropertyDlgStatAccum::initConVarExpr()
{
	if(this->m_iConOn==0)
	{
		...
		GetDlgItem(IDC_COMBO_CON_FUN3)->EnableWindow(FALSE);
...
void CPropertyDlgStatAccum::SetSourceRDBData(CArray<int,int> &m_ArrSourceRDBTagCon,
...
void CPropertyDlgStatAccum::initListBoxHead()
{
	UpdateData();
...
void CPropertyDlgStatAccum::OnSelchangeComboDbsel() 
{
	// TODO: Add your control notification handler code here
...
void CPropertyDlgStatAccum::OnDblclkList1(NMHDR* pNMHDR, LRESULT* pResult) 
{
	// TODO: Add your control notification handler code here
	OnButtonEdit();
	*pResult = 0;
...
void CPropertyDlgStatAccum::OnSelchangeCombo2() 
{
	// TODO: Add your control notification handler code here
	int selIndex=this->m_comboStatType.GetCurSel();
	m_comboBoxDBSel.SetCurSel(selIndex);
	m_comboBoxStatType=selIndex;
	UpdateData(false);
	initListBoxHead();
	initListBoxBody();
}

void CPropertyDlgStatAccum::OnButtonAdv() 
{
	// TODO: Add your control notification handler code here
	CDlgStatAdv dlg;
...
void CPropertyDlgStatAccum::OnCheckCon() 
{
	// TODO: Add your control notification handler code here
	UpdateData(true);
	...
	else
	{
		...
		GetDlgItem(IDC_COMBO_CON_FUN3)->EnableWindow(TRUE);
...
void CPropertyDlgStatAccum::OnSelchangeComboConFun2() 
{
	// TODO: Add your control notification handler code here
	UpdateData(true);
