// PropertyDlgRDBStatSeriesBat.cpp : implementation file
//
...
CPropertyDlgRDBStatSeriesBat::CPropertyDlgRDBStatSeriesBat(CWnd* pParent /*=NULL*/)
	: CDialog(CPropertyDlgRDBStatSeriesBat::IDD, pParent)
{
	//{{AFX_DATA_INIT(CPropertyDlgRDBStatSeriesBat)
		// NOTE: the ClassWizard will add member initialization here
	//}}AFX_DATA_INIT
}


void CPropertyDlgRDBStatSeriesBat::DoDataExchange(CDataExchange* pDX)
{
	CDialog::DoDataExchange(pDX);
	//{{AFX_DATA_MAP(CPropertyDlgRDBStatSeriesBat)
...
BEGIN_MESSAGE_MAP(CPropertyDlgRDBStatSeriesBat, CDialog)
	//{{AFX_MSG_MAP(CPropertyDlgRDBStatSeriesBat)
...
/////////////////////////////////////////////////////////////////////////////
// CPropertyDlgRDBStatSeriesBat message handlers

void CPropertyDlgRDBStatSeriesBat::SetSourceRDBData(CArray<int,int> &m_ArrSourceRDBTagCon,
...
BOOL CPropertyDlgRDBStatSeriesBat::OnInitDialog() 
{
...
void CPropertyDlgRDBStatSeriesBat::initListBoxHead()
{
	UpdateData();
...
void CPropertyDlgRDBStatSeriesBat::initListBoxBody()
{
	int nItem=0;
	CString str;
...
void CPropertyDlgRDBStatSeriesBat::OnSelchangeComboDbsel() 
{
...
void CPropertyDlgRDBStatSeriesBat::OnButtonAdd() 
{
	// TODO: Add your control notification handler code here
...
void CPropertyDlgRDBStatSeriesBat::OnButtonEdit() 
{
	// TODO: Add your control notification handler code here
...
void CPropertyDlgRDBStatSeriesBat::OnButtonDel() 
{
	// TODO: Add your control notification handler code here
		// TODO: Add your control notification handler code here
		POSITION pos = m_List.GetFirstSelectedItemPosition();
...
void CPropertyDlgRDBStatSeriesBat::OnButtonInput() 
{
	// TODO: Add your control notification handler code here
...
void CPropertyDlgRDBStatSeriesBat::OnButtonOutput() 
{
	// TODO: Add your control notification handler code here
	CString filename;
...
void CPropertyDlgRDBStatSeriesBat::OnDblclkList1(NMHDR* pNMHDR, LRESULT* pResult) 
{
	// TODO: Add your control notification handler code here
	OnButtonEdit();
	*pResult = 0;
