// PropertyDlgStateLostPower.cpp : implementation file
//
...
CPropertyDlgStateLostPower::CPropertyDlgStateLostPower(CWnd* pParent /*=NULL*/)
	: CDialog(CPropertyDlgStateLostPower::IDD, pParent)
{
	//{{AFX_DATA_INIT(CPropertyDlgStateLostPower)
		// NOTE: the ClassWizard will add member initialization here
	//}}AFX_DATA_INIT
}


void CPropertyDlgStateLostPower::DoDataExchange(CDataExchange* pDX)
{
	CDialog::DoDataExchange(pDX);
	//{{AFX_DATA_MAP(CPropertyDlgStateLostPower)
...
BEGIN_MESSAGE_MAP(CPropertyDlgStateLostPower, CDialog)
	//{{AFX_MSG_MAP(CPropertyDlgStateLostPower)
...
/////////////////////////////////////////////////////////////////////////////
// CPropertyDlgStateLostPower message handlers

BOOL CPropertyDlgStateLostPower::OnInitDialog() 
{
...
void CPropertyDlgStateLostPower::initListBoxHead()
{
	UpdateData();
	...
	CString Field[5]={"序号","输入变量","弃风时的最小数值","弃风时的最大数值","描述"};
	//列表视的表头
...
void CPropertyDlgStateLostPower::initListBoxBody()
{
	int nItem=0;
	CString str;
...
void CPropertyDlgStateLostPower::initListBoxHead2()
{
	UpdateData();
...
void CPropertyDlgStateLostPower::initListBoxBody2()
{
	int nItem=0;
	CString str;
...
void CPropertyDlgStateLostPower::OnButtonInput() 
{
...
void CPropertyDlgStateLostPower::OnButtonOutput() 
{
	// TODO: Add your control notification handler code here
	CString filename;
...
void CPropertyDlgStateLostPower::OnButtonAdd() 
{
	// TODO: Add your control notification handler code here
...
void CPropertyDlgStateLostPower::OnButtonEdit() 
{
	// TODO: Add your control notification handler code here
...
void CPropertyDlgStateLostPower::OnButtonDel() 
{
	// TODO: Add your control notification handler code here
	POSITION pos = m_List.GetFirstSelectedItemPosition();
...
void CPropertyDlgStateLostPower::OnDblclkList1(NMHDR* pNMHDR, LRESULT* pResult) 
{
	// TODO: Add your control notification handler code here
	OnButtonEdit();
	*pResult = 0;
...
void CPropertyDlgStateLostPower::OnButtonInput2() 
{
	// TODO: Add your control notification handler code here
	// TODO: Add your control notification handler code here
	CFileDialog       dlg( TRUE,".xls", NULL, OFN_NOCHANGEDIR, "Worksheet Files (*.xls)|*.xls||",   NULL   );   
...
void CPropertyDlgStateLostPower::OnButtonOutput2() 
{
	// TODO: Add your control notification handler code here
	// TODO: Add your control notification handler code here
	CString filename;
...
void CPropertyDlgStateLostPower::OnButtonAdd2() 
{
	// TODO: Add your control notification handler code here
	CDlgWindPower dlg;
	if(IDOK==dlg.DoModal())
...
void CPropertyDlgStateLostPower::OnButtonEdit2() 
{
	// TODO: Add your control notification handler code here
...
void CPropertyDlgStateLostPower::OnButtonDel2() 
{
	// TODO: Add your control notification handler code here
	POSITION pos = m_List2.GetFirstSelectedItemPosition();
	CArray<int,int> indexSelArr;
...
void CPropertyDlgStateLostPower::OnOK() 
{
...
void CPropertyDlgStateLostPower::OnDblclkList4(NMHDR* pNMHDR, LRESULT* pResult) 
{
	// TODO: Add your control notification handler code here
	OnButtonEdit2();
	*pResult = 0;
